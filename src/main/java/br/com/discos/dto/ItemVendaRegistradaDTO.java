...
@NoArgsConstructor
@Getter @Setter
public class ItemVendaRegistradaDTO {
	...
	public ItemVendaRegistradaDTO(long codigo, long quantidade, BigDecimal valorUnitario, BigDecimal porcentagemCashback, long codigoDisco, String nomeDisco, long codigoCashback, DiaSemanaEnum dia) {
		super();
		this.codigo = codigo;
